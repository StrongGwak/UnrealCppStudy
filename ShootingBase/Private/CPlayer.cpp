...
{
	Super::BeginPlay();
	FirePosition->SetRelativeLocation(FVector(0.000000, 0.000000, Distance));
...
void ACPlayer::Fire()
{
	...
	ACBullet* bullet = GetWorld()->SpawnActor<ACBullet>(BulletFactory, FirePosition->GetComponentLocation(), FRotator(), param);
